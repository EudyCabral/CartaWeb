<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrodeCarta.aspx.cs" Inherits="CartasWeb.UI.Registros.RegistrodeCarta" %>
        ...
        <div class="container">
            <div class="form-group">
                <div style="text-align: center;">
                    ...
                    <asp:Label ID="LabelCuentas" runat="server" Text="Crear Carta" Font-Size="XX-Large" ForeColor="#0099FF"></asp:Label>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group ">
                        <div class="row" style="align-items: center;">
                            ...
                            <div style="width: 95px;">
                                <asp:Label for="CartaidTextBox" ID="Label6" runat="server" Text="Carta Id:"></asp:Label>
                    ...
                    <div class="form-group">
                        <div class="row" style="align-items: center;">
                            ...
                            <div style="width: 110px;">
                                ...
                                <asp:Label for="DestinatarioTextBox" ID="destiatarioLabel" runat="server" Text="Destinatario Id:"></asp:Label>
                            </div>

                            <asp:TextBox ID="DestinatarioTextBox" runat="server" class="form-control" placeholder="Destinatario Id" Width="250px" TextMode="Number"></asp:TextBox>
                        </div>
                    </div>
